...
> **⚠️ HISTORICAL:** This document describes Cloud Run deployment configuration from an earlier phase. Current deployment: VPS at 195.35.48.184 (studio.egonair.com) via scp + pm2.
...
**Build configuration:**
[HISTORICAL] `cloudbuild.yaml` explicitly injected `SKIP_BASEPATH=1` into the Next.js compilation step.
[HISTORICAL] `gcloud builds submit --config=cloudbuild.yaml --project=egonair-stream-prod`
...
### [HISTORICAL] Cloud Run Environmental Variables
To complete the migration to the root domain, the Cloud Run instance was configured with:
```bash
[HISTORICAL] AUTH_URL=https://egonair-frontend-729286791857.europe-west1.run.app
[HISTORICAL] NEXTAUTH_URL=https://egonair-frontend-729286791857.europe-west1.run.app
# Current values: AUTH_URL=https://studio.egonair.com  NEXTAUTH_URL=https://studio.egonair.com
