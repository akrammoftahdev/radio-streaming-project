              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-base text-neutral-100">{t(type.labelKey)}</div>
                    <div className="text-xs text-neutral-500 mt-0.5 leading-relaxed">{t(type.descKey)}</div>
                  </div>
    ...
    <div dir="rtl" className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="max-w-md w-full bg-neutral-900 border border-neutral-800 rounded-2xl shadow-2xl p-8">
        ...
        <div className={`flex items-center gap-3 mb-6 p-4 rounded-xl border ${colors.card}`}>
          ...
          <div>
            <div className="font-bold text-sm">{t(selected.labelKey)}</div>
            <div className="text-xs opacity-70 mt-0.5 leading-relaxed">{t(selected.descKey)}</div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Name */}
          <div>
            <label className="block text-sm font-medium text-neutral-300 mb-2">{tc("name")}</label>
            <input
              type="text"
              value={name}
          ...
          {/* Email */}
          <div>
            <label className="block text-sm font-medium text-neutral-300 mb-2">{tc("email")}</label>
            <input
              type="email"
              value={email}
          ...
          {/* Phone */}
          <div>
            <label className="block text-sm font-medium text-neutral-300 mb-2">{tc("phone")}</label>
            <input
              type="tel"
              value={phone}
          ...
          <div className="flex flex-col gap-3 py-1">
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm font-medium text-neutral-300 group-hover:text-neutral-100 transition-colors">{tc("active")}</span>
            </label>
            ...
            {accountType !== "DIRECT_DJ" && (
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-sm font-medium text-neutral-300 group-hover:text-neutral-100 transition-colors">{t("broadcastAllowed")}</span>
              </label>
            )}
          </div>
          ...
          >
            {isLoading ? t("adding") : t("addPresenterOfType", { type: t(selected.labelKey) })}
          </button>
        </form>
      </div>
    </div>
