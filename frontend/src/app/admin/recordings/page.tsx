...
/**
 * Admin Recordings Archive — Group 4.2: Presenter Filter
 *
 * Supports ?presenterId=<userId> query param to filter by a specific presenter.
 * All filtering happens server-side — no client-side state required.
 */
export default async function AdminRecordingsPage({
  ...
  // Filters by related presenter.presenterMode (SINGLE_STATION / MULTI_STATION / DIRECT_DJ).
  // Recordings from deleted presenters (presenterId=null) are excluded when this filter is active.
  ...
  // ── File type filter ──────────────────────────────────────────────────────
  // The `format` field stores MIME types: "audio/webm" (default) or "audio/mpeg" (mp3 conversions).
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                      <div className="flex-1 min-w-0">
                        {/* Presenter badge */}
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-800 border border-neutral-700 rounded-lg mb-2">
                          <div
