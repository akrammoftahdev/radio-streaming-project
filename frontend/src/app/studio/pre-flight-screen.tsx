...
export default function PreFlightScreen({
  ...
  const t = useTranslations('studio.preFlight');
    ...
    <div dir={dir} className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md flex flex-col gap-4">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 w-full text-center shadow-2xl relative overflow-hidden">
          ...
          <h1 className="text-2xl font-bold text-neutral-100 mb-6">{t('preparingStudio')}</h1>
          ...
          <div className="space-y-4 text-right mb-8">
            ...
            <div className="flex items-center justify-between p-4 bg-neutral-950/50 rounded-xl border border-neutral-800">
              <span className="font-medium text-neutral-300">{t('browserReady')}</span>
            ...
            {/* Server ready */}
            <div className="flex items-center justify-between p-4 bg-neutral-950/50 rounded-xl border border-neutral-800">
              <span className="font-medium text-neutral-300">{t('serverReady')}</span>
            ...
            <div className={`p-4 bg-neutral-950/50 rounded-xl border ${mounted && micStatus === "denied" ? "border-red-500/50" : "border-neutral-800"}`}>
              <div className="flex items-center justify-between">
                <span className="font-medium text-neutral-300">{t('micPermission')}</span>
                {!mounted ? (
