...
import { notoKufiArabic, inter } from '@/i18n/fonts';
...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} dir={rtl ? 'rtl' : 'ltr'} className={`${notoKufiArabic.variable} ${inter.variable} h-full antialiased font-sans`} style={{ colorScheme: "dark" }}>
