    ...
    <div ref={containerRef} className={`relative inline-block ${className}`}>
      ...
      <button
        ...
        className={`
          ...
          hover:bg-white/10 hover:border-white/20 hover:shadow-lg hover:shadow-violet-500/5
      ...
      >
        {compact ? (
          <Globe className="w-5 h-5 text-white/70 group-hover:text-white transition-colors duration-200" />
        ) : (
          <>
