...
code = code.replace(/placeholder="ابحث بالاسم، اسم المستخدم، الإيميل، أو الهاتف\.\.\."/g, 'placeholder={t("searchPlaceholder")}');
...
code = code.replace(/placeholder="كل المحطات"/g, 'placeholder={t("filterAllStations")}');
...
code = code.replace(/label="مسح كل الفلاتر"/g, 'label={t("clearAllFilters")}');
